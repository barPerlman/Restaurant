...
void
Restaurant::readTablesDescription(const string &delimiter, size_t pos, vector<int> &tablesDescription, ifstream &file,
...
Table *Restaurant::getTable(int ind) {
    ...
    if (ind >= 0 && ind < getNumOfTables()) {
        Table *&requiredTable = tables.at((unsigned long) ind);
